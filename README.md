...
1. How would you describe acessibility on the web to someone new to programming?
  Accessibility is taking all users into account when developing a web page, and ensuring that the user has as seamless an experience as the next whether or not they've a disability
2. Talk about 3 different things you can do to ensure your website is accessible. 
  Use Proper semantic markup, add alt text to images, add aria labels to icons/images
3. How would you explain the concept of a variable to someone new to programming?
A Variable holds a bit of information to be accessed when needed. In some instances it can be changed, and in some instances you don't want it changed. 
4. What is the purpose of using functions in code?
To make your code dynamic and reusable.
